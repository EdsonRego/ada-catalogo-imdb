...
public class DadosFilmes {
    ...
    public void cadastrarFilmeViaAPI(String titulo, String genero, int duracao, double orcamento) {
        ...
        System.out.println("java.projetocatalogoimdb.filme.Filme cadastrado com sucesso!");
    }
    ...
    public void cadastrarAtor(String nomeAtor) {
        ...
        System.out.println("java.projetocatalogoimdb.ator.Ator cadastrado com sucesso!");
    }
    ...
    public void cadastrarDiretor(String nomeDiretor) {
        ...
        System.out.println("java.projetocatalogoimdb.diretor.Diretor cadastrado com sucesso!");
    }
    ...
    public void pesquisarFilmePorNome(String nomeFilme) {
        ...
        if (filme != null) {
            System.out.println("Informações do java.projetocatalogoimdb.filme.Filme:");
            System.out.println("Nome: " + filme.getTitulo());
            System.out.println("Gênero: " + filme.getGenero());
            System.out.println("java.projetocatalogoimdb.diretor.Diretor: " + (filme.getDiretor() != null ? filme.getDiretor().getNomeDiretor() : "Não disponível"));
            System.out.println("Duração: " + filme.getDuracao() + " minutos");
            // Adicione outras informações conforme necessário
        } else {
            System.out.println("java.projetocatalogoimdb.filme.Filme não encontrado.");
        }
    }
